...
const Hobby = () => {
    return(
        ...
        <ul className="hobbyList">
           <li><PlateHobby photo1={basketball1} photo2={basketball2} title='バスケットボール' english='BASKET BALL'>　小学校3年間中学校3年間、高校3年間、大学4年間の計13年間バスケットボールをしていました。なんと人生の半分以上もバスケットボールをしていたらしいです。（笑）大きな身体を使ってゴール下やリバウンドを頑張りチームに貢献しました。3PTシュートは永遠にうまくなりませんでした。（泣）<h4 className="6">主な実績</h4><ul className="basketballAchieve"><li>中学、大学で副キャプテン</li><li>関西学生バスケットボール連盟二部に昇格</li><li>中2で神戸市オールスター選出</li></ul></PlateHobby></li>
           ...
           <li><PlateHobby photo1={variety1} photo2={variety2 }　title='バラエティ' english='VARIETY' >　毎年予選の動画をすべて見るくらいM-1グランプリが好きです。M-1の日はずっとテレビの前で酒を飲みながら見ています。1年で一番楽しみな日です。2019年のミルクボーイの衝撃が未だに抜けていません。<br/>　一番好きな芸人は千鳥です。千鳥が出ている番組は基本全部おもしろいですが一番のおすすめは『いろはに千鳥』です。キー局の千鳥では見られないやる気の無さと悪口がめちゃくちゃおもしろいです。千鳥が好きな人はぜひ見てみてください。<br/><a href="https://tver.jp/series/srm0wbfun2" target="_blank">いろはに千鳥|TVer<a/></a></PlateHobby></li>
           <li><PlateHobby photo1={music1} photo2={music2} title='音楽' english='MUSIC'>　月に一回ライブに行く程度ですがロックバンドが好きです。色々なバンドのライブに行きますが中でも一番好きなバンドがヤバイTシャツ屋さんです。高校1年生のときから聞き始めて顧客歴（ヤバTのファンの名前）8年です。表紙は一人で東京まで行って参加した初の武道館ライブの写真です。<br/>また右の写真は僕の中で最近来てるTHE BONEZというバンドのライブ写真です。ライブは激しくて、もみくちゃにされますがとてもかっこいいバンドです。ぜひ一度聴いて見てください。</PlateHobby></li>
        </ul>
        </div>
    )
}
