...
const Portfolio = () => {
    return(
        ...
        <ul className="portfolioList">
            ...
            <li><PlatePortfolio photo1={event2} photo2={event1} title='日程調整サービス' english='Schedule adjustment service' >　イベントの告知や情報を共有するためのWEBアプリです。NTT西日本の冬季インターン中にチームで作成しました。フロントエンドはReact、バックエンドはPython、サーバーとしてAWSを使いました。初めてのバックエンド担当＆AWSでしたがなんとか動くものを作れて良かったです。AWSにはなかなか苦戦しましたが、慣れれば便利そうだと感じました。とても勉強になる事が多く、貴重な経験ができました。また一人でもAWSに挑戦してみたいと思います。</PlatePortfolio></li>
        </ul>
        </div>
    )
}
